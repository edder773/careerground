...
> 이 문서는 당시 131개 감사 범위의 역사적 기록이다. 같은 날 이후 작성된 232개 최신 감사는
> [최신 232개 전수 감사 재조치](./2026-08-14-latest-full-audit-remediation.md)와
> [최신 감사 조치표](../audits/careerground-latest-full-audit-resolution-2026-08-14.md)가 우선한다.
> 아래의 `127/131`은 최신 감사 232개의 완료 수를 뜻하지 않는다.
